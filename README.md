...
oc-deps teardown plan rhods-operator --save-plan plan.json  # save for apply
```
...
Apply always reads from a saved plan file (generated by `teardown plan --save-plan`).
